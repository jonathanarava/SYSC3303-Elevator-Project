...
Setup Instructions:
	...
	2. Run ElevatorIntermidiate.java with three parameters (number of elevators needed for the system, destination floor 
	for elevator1, and destination floor for elevator2) and FloorIntermidiate.java with one parameter which is the number of floors (ex. 10)

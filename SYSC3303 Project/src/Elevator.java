...
public class Elevator extends Thread {
	 ...
	 */
	public byte[] createResponsePacketData(int requestUpdateErrorError, byte errorType) {//create the Data byte[] for the response packet to be sent to the scheduler
		...
		if (requestUpdateError == REQUEST) {
			...
			//			requestElevator.write(0); // instruction (not used, only from the scheduler)  (not used, only from the scheduler) 
